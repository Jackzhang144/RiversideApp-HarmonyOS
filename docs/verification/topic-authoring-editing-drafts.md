...
结果：`125/125` 通过，`0 Failure / 0 Error / 0 Ignore`，`OHOS_REPORT_CODE: 0`。

覆盖范围：

- 文本选择上的粗体、斜体、标题、链接、引用、代码和列表转换。
...
- Topic 与 Reply 草稿的恢复、sequence 续写、舍弃和成功后清理。
...
4. Emoji、H1/H2/H3、链接、引用、代码、无序/有序列表、单选/多选投票和禁用图片按钮均在 API 23 页面布局中可见。
